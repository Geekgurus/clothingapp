...
<html lang="en">
	...
	<body>
		...
		<div id="final" class="container">
			...
			<p>O item <strong><?= $clothePurchased->name ?></strong> Mack Cloth Shop.</p>
			<a href="?p=home">Complete</a>					
		</div>

		<?php echo ($top3)? "<h2 class='title'>Complete Order</h2>": '' ?>
		...
		<div id="recommendation">
				...
				<div class="clothe-card">
					...
					<?php
						if($functions->alreadyPurchased($clotheRecommended->id)){
							echo "<p class='purchased'>Order Now</p>";
						}else{
							echo "<a href='?p=final&clothe_id=".$clotheRecommended->id."'>Order</a>";
						}
					?>
			...
			<?php
				...
				?>
				<h2 style="color: #000;">New Content</h2>
				<?php
			}
			?>
		</div>
